...

{
  ...
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/lib/finalWalkReport.test.ts" "$ROOT_DIR/apps/api/src/lib/turnReadiness.test.ts" "$ROOT_DIR/apps/api/src/lib/turnMaterials.test.ts" "$ROOT_DIR/apps/api/src/lib/checklistMutation.test.ts" "$ROOT_DIR/apps/api/src/lib/turnMutationGuard.test.ts"
