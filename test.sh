...

{
  ...
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/e2e/upload-batch.test.ts"
  ...
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/routes/itemWorkPlan.test.ts"
  ...
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/lib/notifications.test.ts" "$ROOT_DIR/apps/api/src/lib/pondMilestones.test.ts"
  ...
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/e2e/repair-stage-display.test.ts"
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/e2e/work-cues.test.ts"
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/e2e/turn-status-consistency.test.ts" "$ROOT_DIR/e2e/turn-next-action.test.ts" "$ROOT_DIR/apps/api/src/lib/downRisk.test.ts" "$ROOT_DIR/apps/api/src/lib/projectBudget.test.ts"
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/routes/workStatus.test.ts"
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/routes/availabilityReconciliation.test.ts" "$ROOT_DIR/apps/api/src/lib/availabilityReconciliation.test.ts" "$ROOT_DIR/apps/api/src/routes/completionOverride.test.ts"
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/e2e/pond-eligibility.test.ts"
  ...
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/lib/automationAssignments.test.ts"
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/lib/finalWalks.test.ts"
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/lib/board.test.ts" "$ROOT_DIR/apps/api/src/lib/finalWalkReport.test.ts" "$ROOT_DIR/apps/api/src/lib/turnReadiness.test.ts" "$ROOT_DIR/apps/api/src/lib/turnMaterials.test.ts" "$ROOT_DIR/apps/api/src/lib/checklistMutation.test.ts" "$ROOT_DIR/apps/api/src/lib/turnMutationGuard.test.ts"
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/routes/initialWalkEvidence.test.ts"
  ...
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/routes/propertyBranding.test.ts"
  ...
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/routes/pestReferences.test.ts"
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/routes/pestPatch.test.ts"
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/routes/operationalStaff.test.ts"
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/routes/leaseOverview.test.ts"
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/routes/leasePatch.test.ts"
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/e2e/lease-edit-draft.test.ts"
  ...
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/apps/api/src/lib/pmStarters.test.ts"
