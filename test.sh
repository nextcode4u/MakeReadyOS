...

{
  ...
  node --import "$ROOT_DIR/apps/api/node_modules/tsx/dist/loader.mjs" --test "$ROOT_DIR/e2e/turn-status-consistency.test.ts" "$ROOT_DIR/e2e/turn-next-action.test.ts" "$ROOT_DIR/apps/api/src/lib/downRisk.test.ts"
