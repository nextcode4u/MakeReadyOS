...
Bundled operational templates cover overdue work, move-ins within seven days, missing make-ready dates, schedule-review/date fail-safe attention, pest follow-up, missing flooring scheduling after replacement selection, weekend/edge-day schedule guards, vendor lead-time review, scope-day planning, date-sequence review, daily load review, in-house/vendor routing review, ready-unit stock expectations, and major-scope priority. Pest follow-up requires an active `Pest Follow-Up Date` custom date field. The current date fail-safe template detects incomplete scheduling only; direct comparisons between two board date columns remain a later structured-engine capability.
